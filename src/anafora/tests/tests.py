...
class AnnotateTests(TestCase):
    ...
    jsPattern = re.compile(
        '<script type="text/JavaScript">[\s]*var _setting = ({[\S\s]+});[\s]*</script>',
        re.MULTILINE,
    )
    jsPropertyRepl = re.compile("[{]?([^'\"\s][^'\"\s]*[^'\"\s;])[\s]*:")

    basicSettingDict = {
        "schemaMap": "{&quot;PropBank&quot;: 0, &quot;CrossCoreference&quot;: [&quot;Coref&quot;, &quot;Empty&quot;], &quot;TimeNorm&quot;: 0, &quot;BLT&quot;: 0, &quot;Temporal&quot;: [&quot;RelationReGold&quot;, &quot;Relation&quot;, &quot;Entity&quot;], &quot;Thyme2v1&quot;: [&quot;Correction&quot;, &quot;Coreference&quot;], &quot;THYME_QA&quot;: 0, &quot;Coreference&quot;: 0, &quot;CrossTemporal&quot;: [&quot;Relation&quot;, &quot;Entity&quot;], &quot;Medicine&quot;: 0, &quot;UMLS&quot;: [&quot;Relation&quot;, &quot;Entity&quot;], &quot;BLT-alt&quot;: 0}",
        "root_url": "",
        "app_name": "annotate",
        "remoteUser": "guest",
        "annotator": "guest",
    ...
    def test_selectProject(self):
        ...
        self.assertEqual(response.charset, "utf-8")
        self.assertEqual(
            response.content, "Project Name: 'SampleProject' does not exists"
        )
    ...
    def test_selectCorpus(self):
        ...
        self.assertEqual(response.charset, "utf-8")
        self.assertEqual(
            response.content, "Project Name: 'fakeProject' does not exists"
        )
