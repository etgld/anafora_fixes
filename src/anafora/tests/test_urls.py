...
class AnnotateURLTest(SimpleTestCase):
    ...
    def test_crossDocDir(self):
        testURL = (
            "/anafora/getDir/CrossDocument/ColonCancer/Thyme2v1.Correction/_crossDoc/"
        )
        resolver = resolve(testURL)
        self.assertEqual(
            resolver.view_name, "anafora.views.getTaskFromProjectCorpusName"
        )
        self.assertEqual(
            resolver.kwargs,
            {
                "projectName": "CrossDocument",
                "corpusName": "ColonCancer",
                "schemaName": "Thyme2v1",
                "schemaMode": "Correction",
                "crossDoc": "_crossDoc",
            },
        )
        ...
        self.assertListEqual(
            availableCrossTask["c"], sorted(["ID002", "ID009", "ID027", "ID032"])
        )

    def test_crossDoc_getFile(self):
        resolver = resolve(
            "/anafora/Temporal/ColonCancer/ID060_clinic_176/Temporal.Entity/view/krwr4334/"
        )
        ...
        resolver = resolve(
            "/anafora/CrossDocument/ColonCancer/ID017/CrossCoreference.Coref2/view/_crossDoc/wtchen/"
        )
        self.assertEqual(resolver.view_name, "anafora.views.annotateNormal")
        self.assertDictEqual(
            resolver.kwargs,
        ...
        resolver = resolve(
            "/anafora/CrossDocument/ColonCancer/ID017/CrossCoreference.Coref2/_crossDoc/"
        )
        self.assertEqual(resolver.view_name, "anafora.views.annotateNormal")
        ...
        self.assertEqual(
            resolver.view_name, "anafora.views.getSubTaskFromProjectCorpusTaskName"
        )
        self.assertDictEqual(
            resolver.kwargs,
            {
                "projectName": "Temporal",
                "corpusName": "ColonCancer",
                "parentTaskName": "SeaIce",
            },
        )

        resolver = resolve("/anafora/getDir/THYMEColonFinal/Dev/TimeNorm.Adjudication/")
        self.assertEqual(
            resolver.view_name, "anafora.views.getAdjudicationTaskFromProjectCorpusName"
        )
        self.assertDictEqual(
            resolver.kwargs,
            {
                "projectName": "THYMEColonFinal",
                "corpusName": "Dev",
                "schemaName": "TimeNorm",
                "schemaMode": None,
                "crossDoc": None,
        ...
        resolver = resolve(
            "/anafora/THYMEColonFinal/Dev/ID021_clinic_063/TimeNorm.Adjudication/"
        )
        self.assertEqual(resolver.view_name, "anafora.views.annotateNormal")
        self.assertDictEqual(
            resolver.kwargs,
        ...
        resolver = resolve(
            "/anafora/getDir/CrossDocument/ColonCancer/Thyme2v1.Correction.Adjudication/_crossDoc/"
        )
        self.assertEqual(
            resolver.view_name, "anafora.views.getAdjudicationTaskFromProjectCorpusName"
        )
    ...
    def test_getXML(self):
        resolver = resolve(
            "/anafora/Temporal/ColonCancer/ID060_clinic_176/Temporal.Entity/krwr4334/"
        )
        self.assertEqual(resolver.view_name, "anafora.views.annotateNormal")
        self.assertEqual(
            resolver.kwargs,
        ...
        resolver = resolve(
            "/anafora/Temporal/ColonCancer/ID060_clinic_176/Temporal.Entity.Adjudication/view/"
        )
        self.assertEqual(resolver.view_name, "anafora.views.annotateNormal")
        self.assertEqual(
            resolver.kwargs,
        ...
        resolver = resolve(
            "/anafora/xml/THYMEColonFinal/Dev/ID036_clinic_108/TimeNorm.Adjudication/"
        )
        ...
        resolver = resolve(
            "/anafora/saveFile/TempEval-2013-Train/Test/AP_20130322/TimeNorm.Adjudication/"
        )
        self.assertEqual(resolver.view_name, "anafora.views.writeFile")
        self.assertEqual(
            resolver.kwargs,
            {
                "projectName": "TempEval-2013-Train",
                "corpusName": "Test",
                "schemaName": "TimeNorm",
                "isAdj": "Adjudication",
                "taskName": "AP_20130322",
            },
        )

        resolver = resolve(
            "/anafora/setCompleted/THYMEColonFinal/Test/ID031_clinic_091/Thyme2v1.Coreference.Adjudication/"
        )
        ...
        self.assertEqual(
            resolver.kwargs,
            {
                ...
                "corpusName": "Test",
                "schemaName": "Thyme2v1",
                "schemaMode": "Coreference",
                "isAdj": "Adjudication",
                "taskName": "ID031_clinic_091",
            },
        )

        resolver = resolve(
            "/anafora/setCompleted/THYMEColonFinal/Test/ID031_clinic_091/Thyme2v1.Coreference/"
        )
        self.assertEqual(resolver.view_name, "anafora.views.setCompleted")
        self.assertEqual(
            resolver.kwargs,
        ...
        resolver = resolve(
            "/anafora/setCompleted/THYMEColonFinal/Dev/ID036_clinic_108/TimeNorm.Adjudication/"
        )
        self.assertEqual(resolver.view_name, "anafora.views.setCompleted")
        self.assertEqual(
            resolver.kwargs,
        ...
        resolver = resolve(
            "/anafora/setCompleted/THYMEColonFinal/Dev/ID036_clinic_108/TimeNorm/"
        )
        self.assertEqual(resolver.view_name, "anafora.views.setCompleted")
        self.assertEqual(
            resolver.kwargs,
    ...
    def test_getAnnotator(self):
        annotatorURL0 = (
            "/anafora/annotator/THYMEColonFinal/Dev/ID004_clinic_010/TimeNorm/"
        )
        ...
        annotatorURL1 = (
            "/anafora/annotator/THYMEColonFinal/Dev/ID004_clinic_010/Temporal.Entity/"
        )
        ...
        annotatorURL3 = (
            "/anafora/annotator/Cross-THYMEColonFinal/Train/ID001/Thyme2v1.Correction/"
        )
        ...
        self.assertEqual(
            resolver.kwargs,
            {
                "projectName": "Cross-THYMEColonFinal",
                "corpusName": "Train",
                "taskName": "ID001",
                "schemaName": "Thyme2v1",
                "schemaMode": "Correction",
    ...
    def test_viewAvailableTask(self):
        ...
        self.assertListEqual(
            sorted(availableTask), sorted(["ID049_clinic_142", "ID184_clinic_537"])
        )
        ...
        testURL3 = (
            "/anafora/getDir/THYMEColonFinal/Dev/Temporal.Entity.Adjudication/view/"
        )
        ...
        availableTask = json.loads(response.content)
        self.assertListEqual(
            sorted(availableTask), ["ID002", "ID009", "ID027", "ID032"]
        )
